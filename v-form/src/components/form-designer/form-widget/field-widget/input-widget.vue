<template>
  <form-item-wrapper :designer="designer" :field="field" :rules="rules" :design-state="designState"
    ...
    <el-input ref="fieldEditor" v-model="fieldModel" v-show="!isReadMode"
      ...
      <template #append v-if="field.options.appendButton || field.options.appendText">
        <el-button v-if="field.options.appendButton || field.options.appendText"
                   :disabled="field.options.disabled || field.options.appendButtonDisabled"
                   @click="emitAppendButtonClick">
          <el-icon v-if="field.options.appendButton && !!field.options.buttonIcon"><component :is="field.options.buttonIcon" /></el-icon>
    ...
    <template v-if="isReadMode">
      ...
      <template v-else>
        <span class="readonly-mode-field no-wrap" :title="contentForReadMode">{{contentForReadMode}}</span>
      </template>
    </template>
  </form-item-wrapper>
</template>
