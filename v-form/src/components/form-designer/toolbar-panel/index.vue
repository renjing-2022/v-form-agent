<template>
  <div class="toolbar-container">
    ...
    <el-dialog :title="i18nt('designer.toolbar.preview')" v-model="showPreviewDialogFlag" top="5vh"
               :show-close="true" :close-on-click-modal="false" :close-on-press-escape="false" center draggable
      ...
      <div>
        <div class="form-render-wrapper" :style="{'max-height': previewDialogMaxHeight}"
          ...
          <VFormRender ref="preForm" :form-json="formJson" :form-data="testFormData" :preview-state="true"
                       ...
                       :mix-mode="(layoutType === 'H5') || (layoutType === 'Pad')">
            <template #slot1>
              <div>test1</div>
            </template>
            <template #slot2>
...
<script>
  ...
  export default {
    ...
    created() {
      this.previewDialogMaxHeight = window.innerHeight - 180 + 'px'
