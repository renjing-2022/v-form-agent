  ...
  <container-item-wrapper :widget="widget">
    ...
    <div :class="['sub-form-container', disabledClass, readModeClass]"
      ...
      <div v-for="(subFormRowId, sfrIdx) in rowIdData" class="sub-form-row" :key="subFormRowId">
        ...
        <div v-if="rightActionColumn" class="sub-form-action-column hide-label">
          <div class="action-button-column">
            <el-button :disabled="widgetDisabled || actionDisabled || insertDisabled"
                       circle type="" icon="el-icon-circle-plus-outline" @click="insertSubFormRow(sfrIdx)"
                       v-show="!isReadMode && !widget.options.appendButtonAtBottom"
  ...
  export default {
    ...
    computed: {
      ...
      leftActionColumn() {
        ...
        showFlag = showFlag && (this.widget.options.showRowNumber || !this.widget.options.deleteButtonHidden ||
